...
var SYMBOL_FILTERS = {
  // Forex - consensus 2/3, no volume filter (OTC market)
  ...
  // Crypto - consensus 3/3, volume filter active (OKX real data)
...
async function checkSignal(sym, consensus, cooldownMin) {
  ...
  if (!symFilters.noVol && avgVol>0 && lastVol>0 && lastVol<avgVol*0.7) {
